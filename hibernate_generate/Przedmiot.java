...
public class Przedmiot implements java.io.Serializable {
	...
	public Przedmiot(int id, Uzytkownik uzytkownik, Modulksztalcenia modulksztalcenia) {
		this.id = id;
	...
	public Przedmiot(int id, Specjalizacja specjalizacja, Uzytkownik uzytkownik, Modulksztalcenia modulksztalcenia,
			String rodzaj, String nazwaPl, String nazwaEn, String kod, Integer column, Set<Przedmiotkek> przedmiotkeks,
