...
import pl.edu.pwr.krk.data.entities.Mekkek;

import static org.hibernate.criterion.Example.create;

/**
 * Home object for domain model class Mekkek.
 * @see .Mekkek
 * @author Hibernate Tools
 */
public class MekkekHome {

	private static final Log log = LogFactory.getLog(MekkekHome.class);
