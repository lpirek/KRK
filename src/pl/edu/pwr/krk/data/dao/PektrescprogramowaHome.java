...
import pl.edu.pwr.krk.data.entities.Pektrescprogramowa;

import static org.hibernate.criterion.Example.create;

/**
 * Home object for domain model class Pektrescprogramowa.
 * @see .Pektrescprogramowa
 * @author Hibernate Tools
 */
public class PektrescprogramowaHome {

	private static final Log log = LogFactory.getLog(PektrescprogramowaHome.class);
