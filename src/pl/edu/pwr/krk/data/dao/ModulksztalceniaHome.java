...
import pl.edu.pwr.krk.data.entities.Modulksztalcenia;

import static org.hibernate.criterion.Example.create;

/**
 * Home object for domain model class Modulksztalcenia.
 * @see .Modulksztalcenia
 * @author Hibernate Tools
 */
public class ModulksztalceniaHome {

	private static final Log log = LogFactory.getLog(ModulksztalceniaHome.class);
